        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-white max-w-3xl mx-auto">
              Meet distinguished leaders who are guiding national and regional health initiatives.
            </p>
          </motion.div>

          <div className="flex flex-wrap md:justify-center md:gap-8 mb-8">
            {speakers.slice(0, 2).map((speaker, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -10 }}
                className="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 max-w-sm mb-8 md:mb-0 bg-[#0273a4]/70 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300"
              >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 w-full mx-auto max-w-5xl">
